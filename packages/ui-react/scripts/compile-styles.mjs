/**
 * Pre-compiles the @arviahq/ui-styles `.arv` sources into the build artifacts that
 * `@arviahq/ui-react` ships:
 *
...
const stylesRoot = path.resolve(packageRoot, "../styles/src");
